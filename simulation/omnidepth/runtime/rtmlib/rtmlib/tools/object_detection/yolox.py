    ...
    def postprocess(
        ...
        if outputs.shape[-1] == 4 or outputs.shape[-1] > 5:
            ...
            if dets is not None:
                ...
                # multiclass_nms already applies score_thr.  Using nms_thr
                # here accidentally turns the NMS overlap threshold into a
                # second (and usually much stricter) confidence threshold.
