...
try:
    ...
    # Runtime inference only opens local model files.  Keep that path usable
    # in the lean Jetson container without pulling a progress-bar dependency;
    # this fallback is also sufficient if a download is explicitly requested.
